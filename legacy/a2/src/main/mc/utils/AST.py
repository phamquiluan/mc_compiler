...
class ArrayPointerType(Type):
    ...
    def __str__(self):
        return "ArrayType(" + str(self.eleType) + ")"
...
class UnaryOp(Expr):
    ...
    def __str__(self):
        return "BinaryOp(" + self.op + "," + str(self.body) + ")"
...
class If(Stmt):
    ...
    def __str__(self):
        return "If(" + str(self.expr) + "," + str(self.thenStmt) + (",None" if (self.elseStmt is None) else ",Some(" + str(self.elseStmt) + ")") + ")"
...
class Dowhile(Stmt):
    ...
    def __str__(self):
        return "Dowhile(List(" + ','.join(str(i) for i in self.sl) + ")," + str(self.exp) + ")"
